...
app.get("/api/users", (req, res) => {
    ...
    console.log(
        "FINORA ROUTE HIT: GET /api/users"
    );
...
/* =========================================================
   ...
   THIS MUST WORK BEFORE WE TEST REGISTRATION.
========================================================= */

app.get("/api/users/test", (req, res) => {

    console.log(
        "FINORA ROUTE HIT: GET /api/users/test"
    );
...
app.post("/api/users/register", async (req, res) => {
    ...
    console.log(
        "FINORA ROUTE HIT: POST /api/users/register"
    );
    ...
    try {
        ...
        if (
            ...
            return res.status(400).json({
                ...
                message:
                    "Full name, phone, email, password and confirm password are required."
...
app.post("/api/users/login", async (req, res) => {
    ...
    console.log(
        "FINORA ROUTE HIT: POST /api/users/login"
    );
...
app.get("/api/users/:id", async (req, res) => {
    ...
    console.log(
        "FINORA ROUTE HIT: GET /api/users/:id",
        req.params.id
    );
